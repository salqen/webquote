...
const BLOCK_ORDER = {
  "info-project":1, "info-industry":2, "info-company":3, "info-address":4, "info-socials":5, "info-details":6,
  "brief-type":7, "brief-structure":8, "brief-goal":9, "brief-desc":10,
  "brand-logo":11, "brand-preset":12, "brand-colors":13, "brand-fonts":14, "brief-nav":15,
  "content-core":16, "content-content":17, "content-social":18, "content-convert":19, "content-extra":20,
  "content-integrations":21,
  "assets-files":22,
  "wiz-summary":23,
};
const CAT_BLOCK_ORDER = { core:16, content:17, social:18, convert:19, extra:20 };

// ── WIZARD — sprievodca pre jednoduchý režim ────────────────
// Každý krok = zoznam blokov, ktoré sú v ňom viditeľné.
const WIZARD_STEPS = [
  { id:"data",    icon:"🏢", blocks:["info-project","info-industry","info-company","info-address","info-socials"] },
